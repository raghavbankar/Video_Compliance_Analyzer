...
logger=logging.getLogger("Video_Compliance")
logging.basicConfig(level=logging.INFO)

# NODE 1 : Indexer
# Converting the video into texts(transcript)
...
def audio_content_node(state:VideoAuditState)-> Dict[str,Any]:
    """
    Performs Retrieval Augemented Generation to audit the content --- the video
    Transcript is accessed from the previous state
    """
    
    logger.info("----[Node:Auditor] quering knowledge base and llm")
